...
public interface EventService {
    List<FullEventDto> getEventsWithParams(String text, List<Integer> categories, boolean paid, String rangeStart, String rangeEnd, boolean onlyAvailable, String sort, Integer from, Integer size);

    FullEventDto getEventById(Long id);

    List<FullEventDto> getEventsWithParamsAdmin(List<Long> users, List<State> states, List<Integer> categories, String rangeStart, String rangeEnd, Integer from, Integer size);
